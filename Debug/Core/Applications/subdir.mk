...
C_DEPS += \
./Core/Applications/MovingAverageFilter.d \
...
clean-Core-2f-Applications:
	-$(RM) ./Core/Applications/MovingAverageFilter.cyclo ./Core/Applications/MovingAverageFilter.d ./Core/Applications/MovingAverageFilter.o ./Core/Applications/MovingAverageFilter.su ./Core/Applications/VoltInterpolation.cyclo ./Core/Applications/VoltInterpolation.d ./Core/Applications/VoltInterpolation.o ./Core/Applications/VoltInterpolation.su
